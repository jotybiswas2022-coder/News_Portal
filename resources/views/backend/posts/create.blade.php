...
<style>
.product-card { border-radius: 14px; background: rgba(255,255,255,0.88); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); border: 1px solid rgba(233,238,243,0.8); }
.product-card:hover { background: rgba(255,255,255,0.95); }
.form-control, .form-select { background: rgba(255,255,255,0.7); backdrop-filter: blur(4px); -webkit-backdrop-filter: blur(4px); border: 1px solid rgba(221,221,221,0.7); }
.form-control:focus, .form-select:focus { border-color:#4f46e5; box-shadow:0 0 0 0.15rem rgba(79,70,229,0.25); background: rgba(255,255,255,0.95);}
