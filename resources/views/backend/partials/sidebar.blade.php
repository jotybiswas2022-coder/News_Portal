...
<nav class="navbar navbar-expand-lg shadow-sm py-2" style="background: #ffffff;">
    <div class="container-fluid">
        <!-- Single Mobile Menu Toggle (Hamburger) -->
...
<div class="row m-0" style="min-height: 100vh;">
    ...
    <!-- Mobile Slide-in Menu (Combines Sidebar + Top Nav) -->
    <div class="col-md-3 p-0">
        <div class="mobile-menu" id="mobileMenu">
            <!-- Header with Close Button -->
            <div class="mobile-menu-header d-lg-none d-flex justify-content-between align-items-center p-3 border-bottom">
...
@media (max-width: 991.98px) {
    ...
    .sidebar { display: none !important; } /* Hide desktop sidebar on mobile */
}
