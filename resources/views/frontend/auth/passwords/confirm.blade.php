...
<head>
    ...
    <title>Confirm Password | News Portal</title>
    <style>
...
<body>
<!-- ===== NEWS PORTAL DARK — CONFIRM PASSWORD PAGE ===== -->
    ...
    <div class="np-dark-center">
        ...
        <div class="np-dark-card">
            ...
            <div class="np-dark-head">
                ...
                <p class="np-dark-sub" id="npTypingSub">Confirm Your Identity.</p>
            ...
            <div class="np-dark-body">
                ...
                <form method="POST" action="{{ route('password.confirm') }}">
                    ...
                    <button type="submit" class="np-dark-btn" id="npConfirmBtn" style="--f-delay:0.3s;">
                        <i class="bi bi-shield-check"></i>
                ...
                <div class="np-dark-or" style="--f-delay:0.45s;">
                    <span class="np-dark-or-line"></span>
                    <span class="np-dark-or-text">
                        <i class="bi bi-diamond-fill"></i> Trouble Signing In? <i class="bi bi-diamond-fill"></i>
                    </span>
                    <span class="np-dark-or-line"></span>
                </div>

                <div class="np-dark-register" style="--f-delay:0.55s;">
                    @if (Route::has('password.request'))
                    <a href="{{ route('password.request') }}" class="np-dark-reg-btn">
...
<script>
    ...
    const confirmBtn = document.getElementById('npConfirmBtn');
    if (confirmBtn) {
        confirmBtn.closest('form').addEventListener('submit', () => {
            confirmBtn.classList.add('np-dark-loading');
    ...
    (function typeEffect() {
        ...
        if (!el) return;
        const words = ['Confirm Your Identity.', 'Secure Your Session.', 'Stay Protected.', 'Authorized Access Only.'];
