...
<body>
<!-- ===== NEWS PORTAL DARK — FORGOT PASSWORD PAGE ===== -->
    ...
    <div class="np-dark-center">
        ...
        <div class="np-dark-card">
            ...
            <div class="np-dark-head">
                ...
                <p class="np-dark-sub" id="npTypingSub">Reset Your Password.</p>
            ...
            <div class="np-dark-body">
                ...
                @if (session('status'))
                    <div class="np-dark-alert-success">
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <button type="submit" class="np-dark-btn" style="--f-delay:0.3s;">
                ...
                <div class="np-dark-or" style="--f-delay:0.45s;">
                    ...
                    <span class="np-dark-or-text">
                        <i class="bi bi-diamond-fill"></i> Remember your password? <i class="bi bi-diamond-fill"></i>
                    </span>
                    <span class="np-dark-or-line"></span>
                </div>
...
<script>
    ...
    const resetBtn = document.querySelector('.np-dark-btn');
    if (resetBtn) {
    ...
    (function typeEffect() {
        ...
        if (!el) return;
        const words = ['Reset Your Password.', 'Recover Your Account.', 'We Will Help You.', 'Stay Secure.'];
...
<style>
    ...
    *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .np-dark-alert-success i { font-size: 16px; }
