    ...
    <div class="np-dark-center">
        ...
        <div class="np-dark-card">
            ...
            <div class="np-dark-head">
                ...
                <p class="np-dark-sub" id="npTypingSub">Verify Your Email.</p>
            ...
            <div class="np-dark-body">
                ...
                <p class="np-dark-info-text" style="margin-bottom: 16px;">
...
<script>
    ...
    const verifyBtn = document.querySelector('.np-dark-btn');
    if (verifyBtn) {
        verifyBtn.closest('form').addEventListener('submit', () => {
            verifyBtn.classList.add('np-dark-loading');
    ...
    (function typeEffect() {
        ...
        if (!el) return;
        const words = ['Verify Your Email.', 'Confirm Your Identity.', 'Secure Your Account.', 'Stay Protected.'];
