...
<style>
    ...
    @media (max-width: 768px) {
        .np-contact-section { padding: 50px 16px 30px; min-height: auto; }
        .np-contact-form-card { padding: 28px 20px; }
        .np-contact-header { margin-bottom: 32px; }
        .np-contact-header h2 { font-size: 28px; }
        .np-contact-header p { font-size: 13px; padding: 0 10px; }
        .np-info-box { padding: 18px 16px; gap: 14px; }
        .np-info-icon { width: 44px; height: 44px; min-width: 44px; font-size: 17px; }
        .np-info-text h6 { font-size: 14px; }
        .np-info-text p { font-size: 12px; }
    }

    @media (max-width: 480px) {
        .np-contact-section { padding: 40px 14px 24px; }
        .np-contact-form-card { padding: 24px 16px; }
        .np-contact-form-card::before { display: none; }
        .np-submit-btn { padding: 14px 20px; font-size: 13px; letter-spacing: 1px; }
        .np-info-box { padding: 16px 14px; }
        .np-footer { padding: 24px 16px; }
    }
</style>
