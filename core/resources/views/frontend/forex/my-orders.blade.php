...
.orders-header-icon{width:3.5rem;height:3.5rem;margin:0 auto 1rem;border-radius:1rem;background:rgba(0,200,255,0.08);border:1px solid rgba(0,200,255,0.12);display:flex;align-items:center;justify-content:center;color:#00c8ff;transition:all 0.3s ease}
.orders-header-icon:hover{box-shadow:0 0 30px rgba(0,200,255,0.15);transform:translateY(-2px)}
...
.orders-stat-dot.processing{background:#00c8ff}
.orders-stat-dot.completed{background:#00c8ff}
...
.my-orders-card:hover{border-color:rgba(0,200,255,0.18);background:rgba(5,5,15,0.6);box-shadow:0 8px 32px -8px rgba(0,0,0,0.3)}
.my-orders-card-left{display:flex;align-items:center;gap:0.875rem;flex:1;min-width:0}
.my-orders-card-icon{width:2.5rem;height:2.5rem;border-radius:0.75rem;background:rgba(0,200,255,0.06);border:1px solid rgba(0,200,255,0.1);display:flex;align-items:center;justify-content:center;color:rgba(0,200,255,0.6);flex-shrink:0;transition:all 0.3s ease}
.my-orders-card:hover .my-orders-card-icon{background:rgba(0,200,255,0.1);border-color:rgba(0,200,255,0.2);color:#00c8ff}
.my-orders-card-icon svg{width:1.125rem;height:1.125rem}
.my-orders-card-info{min-width:0;flex:1}
.my-orders-card-number{font-family:'JetBrains Mono',monospace;font-size:0.8125rem;font-weight:600;color:#00c8ff;display:block;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
...
.my-orders-card:hover .my-orders-card-arrow{color:#00c8ff;transform:translateX(4px)}
...
.my-orders-nav-link:hover:not(.disabled):not(.active){color:#EAEAEA;background:rgba(0,200,255,0.06);border-color:rgba(0,200,255,0.15)}
.my-orders-nav-link.active{color:#fff;background:rgba(0,200,255,0.12);border-color:rgba(0,200,255,0.25);pointer-events:none}
...
.my-orders-empty-icon:hover{border-color:rgba(0,200,255,0.2);box-shadow:0 0 30px rgba(0,200,255,0.08)}
...
.my-orders-empty-btn{display:inline-flex;align-items:center;gap:0.5rem;padding:0.75rem 1.75rem;background:linear-gradient(135deg,#00c8ff,#0099ff);color:white;font-weight:600;font-size:0.875rem;border-radius:0.75rem;text-decoration:none;transition:all 0.3s ease}
.my-orders-empty-btn:hover{transform:translateY(-2px);box-shadow:0 8px 30px rgba(0,200,255,0.25)}
...
.orders-sort-btn:hover{color:#EAEAEA;background:rgba(0,200,255,0.06);border-color:rgba(0,200,255,0.15)}
.orders-sort-btn.active{color:#fff;background:rgba(0,200,255,0.12);border-color:rgba(0,200,255,0.25)}
                    ...
                    <div class="my-orders-card-right">
                        @php
                            $statusColors = [
                                ...
                                'processing'        => ['bg' => 'rgba(0,200,255,0.1)',  'border' => 'rgba(0,200,255,0.15)',  'dot' => '#00c8ff', 'label' => 'Processing'],
                                'completed'         => ['bg' => 'rgba(0,200,255,0.1)',  'border' => 'rgba(0,200,255,0.15)',  'dot' => '#00c8ff', 'label' => 'Completed'],
